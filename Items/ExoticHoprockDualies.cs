...
namespace FortniteItems.Items
{
    public class ExoticHoprockDualies : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("33% chance to not use ammo\n\"It's a shame you can't hold two pistols at once\"");
        ...
        public override void SetDefaults()
        {
            ...
            Item.rare = ModContent.RarityType<Exotic>(); //Post plaguebringer goliath
        ...
        {
            player.AddBuff(ModContent.BuffType<Buffs.OtherworldlyGravity>(), 10);
        }
    }
}
