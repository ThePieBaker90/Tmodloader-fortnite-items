...
namespace FortniteItems.Content.Items.Weapons
{
    ...
    {
        public override string Texture => $"{nameof(FortniteItems)}/Assets/Textures/MavenAutoShotgun";
        ...
        public override void AddRecipes()
        {
            ...
            if (calamityMod != null && calamityMod.TryFind("CorrodedFossil", out ModItem Fossil) && calamityMod.TryFind("EssenceofSunlight", out ModItem Sunlight))
            {
