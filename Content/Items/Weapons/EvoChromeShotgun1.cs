...
{
    public class EvoChromeShotgun1 : ModItem
    {
        public override string Texture => $"{nameof(FortniteItems)}/Assets/Textures/EvoChromeShotgun1";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("EvoChrome Shotgun MKI");
            // Tooltip.SetDefault("A shotgun that is upgraded throughout the lunar events!\nEach upgrade increases damage and adds 1 additional bullet\n\"Chrome will consume all\"");
