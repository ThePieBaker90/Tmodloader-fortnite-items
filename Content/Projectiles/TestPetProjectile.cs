...
{
    public class TestPetProjectile : ModProjectile
    {
        //Code originates from https://github.com/tModLoader/tModLoader/blob/1.4.4/ExampleMod/Content/Pets/ExamplePet/ExamplePetProjectile.cs
        ...
        public override void AI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<TestPetBuff>()))
            {
