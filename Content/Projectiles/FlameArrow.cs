    ...
    public class FlameArrow : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                var projectile = Projectile.NewProjectileDirect(Terraria.Entity.InheritSource(Projectile), position, Projectile.velocity, ProjectileID.MolotovCocktail, 25, 10, Main.myPlayer);
