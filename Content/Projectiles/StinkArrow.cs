    ...
    public class StinkArrow : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                var projectile = Projectile.NewProjectileDirect(Terraria.Entity.InheritSource(Projectile), position, Projectile.velocity, ProjectileID.ToxicFlask, 40, 10, Main.myPlayer);
